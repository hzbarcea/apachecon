...
public class SpeechBubble {
    ...
    /**
     * Format message as a collection of lines to display to fit in a given width
    ...
    public void paintBubble(List<String> lines, Graphics2D graphics) {
        ...
        Point arrowLeft = new Point(OUT_PADDING + bubbleWidth - ARROW_DELTA - ARROW_WIDTH, OUT_PADDING + bubbleHeight);
        Point arrowRight = new Point(OUT_PADDING + bubbleWidth - ARROW_DELTA, OUT_PADDING + bubbleHeight);
        Point arrowBottom = new Point(OUT_PADDING + bubbleWidth - ARROW_DELTA, OUT_PADDING + bubbleHeight + ARROW_HEIGHT);
        Polygon arrow = new Polygon(
            new int[] {arrowLeft.x, arrowRight.x, arrowBottom.x},
